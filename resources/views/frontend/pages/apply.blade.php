                ...
                <form action="{{ route('tour.apply', $package->id) }}" method="POST">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                <label>Name</label>
                                <input type="text" class="form-control" value="{{ $tourist->name }}" readonly>
                            </div>

                            <div class="mb-2">
                                <label>Email</label>
                                <input type="email" class="form-control" value="{{ $tourist->email }}" readonly>
                            </div>

                            <div class="mb-2">
                                <label>Date of Birth</label>
                                <input type="text" class="form-control" value="{{ $tourist->date_of_birth }}" readonly>
                            </div>

                            <div class="mb-2">
                                <label>Gender</label>
                                <input type="text" class="form-control" value="{{ ucfirst($tourist->gender) }}" readonly>
                            </div>

                            <div class="mb-2">
                                <label>Nationality</label>
                                <input type="text" class="form-control" value="{{ $tourist->nationality }}" readonly>
                            </div>

                            <div class="mb-2">
                                <label>NID / Passport</label>
                                <input type="text" class="form-control" value="{{ $tourist->nid_passport }}" readonly>
                            </div>
                        </div>
                    </div>
