                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="phone" class="form-control"
                                    value="{{ old('phone', $tourist->phone) }}" required>
                            </div>

                            <div class="mb-2">
                                <label>Present Address</label>
                                <textarea name="present_address" class="form-control"
                                    required>{{ old('present_address', $tourist->address) }}</textarea>
                            </div>
                            ...
                            <div class="mb-2">
                                ...
                                <input type="number" name="total_persons"
                                    class="form-control"
                                    value="{{ old('total_persons') }}" required>
                            </div>
